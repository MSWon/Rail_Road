...
window = 10
path_model = "./north_speed_model_rf.pkl"

train_batch = make_batch(train_data)
X_train, Y_train = make_window(train_batch, window, "speed")
...
model = ExtraTreesRegressor(n_estimators = 198, max_features = 0.5248, max_depth = 27, 
